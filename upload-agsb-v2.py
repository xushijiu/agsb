...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "shijiu"         # 用户名
UUID = "83bb8cba-608a-47c9-9672-5135d1963ebe"                     # UUID，留空则自动生成
PORT = 56789                   # Vmess端口，留空或0则自动生成
DOMAIN = "my361.dpdns.org"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiNDFkNTVjZDVhNDZkNzZiODgyNDI1ZDA0NWY4OTRlMDEiLCJ0IjoiNDIyNjU3NDgtNDA5ZS00OGY3LTk2NDktYWY3MDQ1N2JhOGNkIiwicyI6Ik5UWXpNRGcyT0dFdE1qVXhOeTAwTW1Wa0xXSmxOelV0WlRJNU5XUTJaRFE1WVRZMSJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
